...
File for splitting the data into training and testing dataset
This split has a fixed allows us to put a fixed random seed so there is no "element of randomness" in the split.
It takes into account to split specific sites in to training and testing so we do not train and test in the same sites.

!!! If you want to change where the program reads and takes the images from, please check the apply_augmentation function. !!!
"""
